...
class TrafficSim2D:
    ...
    def _draw_dashed_lane_line(self, surface, y_pos, cross_road_x, orientation):
        ...
        if orientation == 'horizontal':
            ...
            crosswalk_margin = 55   # Margem para faixas de pedestres (AUMENTADO para 55 - CORREÇÃO FINAL)
            
            # Limites precisos considerando crosswalks
            intersection_start = cross_road_x - crosswalk_margin  # Começar 55px antes da rua
            intersection_end = cross_road_x + intersection_width + crosswalk_margin  # Terminar 55px depois
    ...
    def _draw_directional_arrows(self, surface, cross_road_x, road_y):
        ...
        intersection_start = cross_road_x - 55  # Margem da intersecção (CONSISTENTE com 55px)
        intersection_end = cross_road_x + 80 + 55  # Fim da intersecção + margem
