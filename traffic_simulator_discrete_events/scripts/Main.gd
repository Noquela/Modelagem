...
# INTEGRAÇÃO COM EVENTOS DISCRETOS
var simulador_trafego: SimuladorTrafego
var is_running: bool = true

func _ready():
	print("🌍 Main iniciando com mundo visual completo + eventos discretos")
	
	# Criar SimuladorTrafego para gerenciar eventos discretos
	simulador_trafego = SimuladorTrafego.new()
	add_child(simulador_trafego)
